...
extension ComplexClassTests {

   static var allTests: [(String, (ComplexClassTests) -> () throws -> Void)] {
      return [
...
extension ComplexStructTests {

   static var allTests: [(String, (ComplexStructTests) -> () throws -> Void)] {
      return [
                ("testInitWithNoArguments", testInitWithNoArguments),
                ("testInitWithArguments", testInitWithArguments),
                ("testEqualWithNoArguments", testEqualWithNoArguments),
